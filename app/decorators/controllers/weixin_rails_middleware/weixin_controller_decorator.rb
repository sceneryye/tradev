...
WeixinRailsMiddleware::WeixinController.class_eval do
    ...
    case @keyword
      ...
      when 'subscribe'
        if id == 78
          ...
          # link_url=""
          title ="欢迎加入尾货良品大家庭"
          desc = "这是一个基于移动互联网的乐淘社区，宗旨是为成员推出最优性价比的实用商品，并享受时刻在身边的便捷服务。无论是家用还是公司福利，我们都在保证品质的同时，会为你省下真金白银。"
          pic_url="http://vshop.trade-v.com/images/homepage/weho.jpg"
          link_url = "http://vshop.trade-v.com/weihuo/shops/49"
  ...
  def response_text_message(options={})
    ...
    when /^推送/
      ...
      url = 'http://www.trade-v.com/weihuo/template_information'
